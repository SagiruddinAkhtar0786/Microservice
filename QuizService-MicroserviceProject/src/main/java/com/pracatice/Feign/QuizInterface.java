...
public interface QuizInterface {
	...
	@PostMapping("question/getQuestions")  //http://localhost:8081/question/getQuestions
	public ResponseEntity<List<QuestionWrapper>> getQuestionFromId(@RequestBody List<Integer> questionsId);
	
	@PostMapping("question/getScore") //http://localhost:8081/question/getScore
